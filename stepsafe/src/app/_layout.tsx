...
// 1. IMPORT YOUR NEW BIOMETRIC & JOURNEY PROVIDERS
import { BiometricProvider } from '@/context/BiometricContext';
import { JourneyProvider } from '@/context/JourneyContext'; // Import new provider[cite: 6]
...
export default function TabLayout() {
  ...
  return (
    // 2. WRAP WITH BOTH PROVIDERS
    // Make sure JourneyProvider is nested correctly
    <BiometricProvider>
      <JourneyProvider> 
