...
const HISTORY_DATA = [
  { 
    ...
    status: 'Safe', 
    isAlert: false,
    pathImage: require('../../assets/images/historydummy/path1.png') // Local file
  },
  { 
    id: '2', 
      ...
      <Modal visible={!!selectedJourney} animationType="slide" transparent={true}>
        <View style={styles.modalOverlay}>
          <View style={styles.detailModal}>
            ...
            <Image 
              source={selectedJourney?.pathImage} // Uses the path linked in the data
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#FFF', borderRadius: 16, padding: 16, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.03, shadowRadius: 8, elevation: 2, borderWidth: 1, borderColor: '#F3F4F6' },
  cardAlert: { borderColor: '#FEE2E2', backgroundColor: '#FEF2F2' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  dateText: { fontSize: 13, color: '#4B5563', fontWeight: '600' },
  ...
  iconBg: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#F3F4F6', justifyContent: 'center', alignItems: 'center' },
  routeInfo: { flex: 1, marginLeft: 12 },
  destinationText: { fontSize: 16, fontWeight: '700', color: '#111', marginBottom: 4 },
  durationRow: { flexDirection: 'row', alignItems: 'center' },
  durationText: { fontSize: 12, color: '#6B7280', marginLeft: 4 },
  alertLogBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', padding: 10, borderRadius: 8, borderWidth: 1, borderColor: '#FECACA' },
  alertLogText: { fontSize: 12, color: '#DC2626', fontWeight: '600' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  detailModal: { backgroundColor: '#FFF', height: '75%', borderTopLeftRadius: 24, borderTopRightRadius: 24, overflow: 'hidden' },
  mapPathImage: { width: '100%', height: 250 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', padding: 20 },
  modalTitle: { fontSize: 20, fontWeight: '800' },
  routePathContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  lineConnector: { width: 2, height: 24, backgroundColor: '#E5E7EB', marginHorizontal: 4 },
  routeTextContainer: { marginLeft: 12, flex: 1 },
  routeLabel: { fontSize: 14, fontWeight: '600', color: '#374151', marginBottom: 4 },
  dotCurrent: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#3B82F6' },
  dotDestination: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#EF4444' },
});