  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.mapBackground}>
        {/* Pass the dynamic coordinates to the map component */}
        <AppMap userLocation={userCoords} />
      </View>
...
const styles = StyleSheet.create({
  ...
  mapBackground: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#E5E7EB', justifyContent: 'center', alignItems: 'center' },
  overlay: { flex: 1, justifyContent: 'space-between', padding: 20, paddingBottom: 100 },
  searchContainer: { marginTop: 10 },
  searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderRadius: 16, paddingHorizontal: 16, paddingVertical: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 5 },
  searchInput: { flex: 1, marginLeft: 12, fontSize: 16, color: '#111', fontWeight: '500' },
  biometricBadge: { position: 'absolute', right: 16, top: 100, backgroundColor: '#FFFFFF', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 24, flexDirection: 'row', alignItems: 'center', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 4, zIndex: 10, borderWidth: 1, borderColor: '#E2E8F0' },
  joystickContainer: { position: 'absolute', bottom: 270, left: 20, alignItems: 'center', zIndex: 20 },
  joystickBase: { width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(255, 255, 255, 0.7)', borderWidth: 2, borderColor: 'rgba(203, 213, 225, 0.8)', justifyContent: 'center', alignItems: 'center' },
  joystickStick: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#3B82F6', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 5 },
  joystickLabel: { marginTop: 8, fontSize: 12, fontWeight: '700', color: '#334155', backgroundColor: 'rgba(255, 255, 255, 0.8)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
  bottomPanel: { backgroundColor: '#FFF', borderRadius: 24, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.05, shadowRadius: 12, elevation: 10 },
  locationRow: { flexDirection: 'row', alignItems: 'center' },
  locationText: { fontSize: 15, fontWeight: '600', color: '#111', marginLeft: 12 },
  dotCurrent: { width: 12, height: 12, borderRadius: 6, backgroundColor: '#3B82F6', borderWidth: 3, borderColor: '#DBEAFE' },
  dotDestination: { width: 12, height: 12, borderRadius: 6, backgroundColor: '#EF4444', borderWidth: 3, borderColor: '#FEE2E2' },
  locationConnector: { width: 2, height: 20, backgroundColor: '#E5E7EB', marginLeft: 5, marginVertical: 4 },
  routeMetrics: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#F8FAFC', paddingHorizontal: 12, paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: '#F1F5F9', marginBottom: 16, marginTop: 8 },
  startButton: { backgroundColor: '#22C55E', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', paddingVertical: 18, borderRadius: 16, marginTop: 24 },
